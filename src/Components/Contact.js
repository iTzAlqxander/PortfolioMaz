        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            ...
            <div className="social-links flex space-x-4 mt-6">
              ...
              <a href="mailto:alex.maszstak@gmail.com" className="hover:text-[#6fddf8] transition duration-300"><FaEnvelope size={28} /></a>
            </div>
            <div className="mt-6">
              <a href="/path/to/your/resume.pdf" download className="inline-block px-6 py-3 rounded-full text-black bg-gradient-to-r from-[#6fddf8] to-[#007CF0] hover:from-[#5bc6ff] hover:to-[#4da7db] transition duration-300 shadow-lg">
